module TestDatabaseTimeSeriesGroup
...
@testset "Time Series Group" begin
    @testset "Read" begin
    ...
    @testset "Update By Label" begin
        ...
        Quiver.update_time_series_group_by_label!(db, "Collection", "data", "Item 2";
            date_time = ["2024-01-01T00:00:00"],
            value = [99.0],
        )
        Quiver.update_time_series_group_by_label!(db, "Collection", "data", "Item 1";
            date_time = ["2024-01-01T00:00:00", "2024-01-02T00:00:00"],
            value = [1.5, 2.5],
        )
        @test Quiver.read_time_series_group(db, "Collection", "data", item)["value"] == [1.5, 2.5]
